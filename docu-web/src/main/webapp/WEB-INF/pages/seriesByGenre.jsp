 ...
 <!--****************** -->
  ...
  <section class="content">
 	...
 	<h3 style="color:#B0C4DE;margin-top:-10px;margin-left:10px">
   		Serie &gt; <img height="32" width="32" src="data:image/jpg;base64,${genre.icone}" />&nbsp;${genre.name}
   		<hr>
  	</h3>
     ...
     <div class="row" style="padding:10px">
       ...
       <c:forEach var="serie" items="${listSeriesbean}" varStatus="serieLoop">

        <div class="col-md-2">
       	 <div class="box" style="margin-right:10px;height:260px;width:160px;border:1px solid #333333;background-color:#052E3C"">

          <div class="box-header">
           <h5 style="color:#F5F5DC;font-size:12px;text-align:center">${serie.titre}</h5>
          </div>

          <div class="box-body" style="text-align:center;">
          	<a class="openModalRead"
               data-toggle="modal" data-target="#modalRead" data-uid="${serie.id}">
           		<img style="position:absolute;top:60px;left:15px;height:180px;width:130px;border:1px solid #CCCCCC;margin-top:-10px"
           			 src="data:image/jpg;base64,${serie.image}" />
           	</a>
           <p style="position:absolute;bottom:-5px;left:70px;color:#EEEEFF;margin-top:5px"><small>(${serie.anneeDebut}-${serie.anneeFin})</small></p>
          </div>
